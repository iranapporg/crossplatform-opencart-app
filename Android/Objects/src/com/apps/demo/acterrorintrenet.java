...
public class acterrorintrenet extends Activity implements B4AActivity{
	public static acterrorintrenet mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.apps.demo", "com.apps.demo.acterrorintrenet");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (acterrorintrenet).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.apps.demo", "com.apps.demo.acterrorintrenet");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.apps.demo.acterrorintrenet", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (acterrorintrenet) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (acterrorintrenet) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (acterrorintrenet) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public anywheresoftware.b4a.objects.ButtonWrapper _btnretry = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 22;BA.debugLine="Activity.LoadLayout(\"frmerronet\")";
mostCurrent._activity.LoadLayout("frmerronet",mostCurrent.activityBA);
...
mostCurrent._library._setlocalapp(mostCurrent.activityBA,mostCurrent._library._currlang);
 //BA.debugLineNum = 26;BA.debugLine="Library.ChangeStatusColor";
mostCurrent._library._changestatuscolor(mostCurrent.activityBA);
 //BA.debugLineNum = 28;BA.debugLine="lbltitle.Text	= Library.GetStringResourse(\"error_";
mostCurrent._lbltitle.setText(BA.ObjectToCharSequence(mostCurrent._library._getstringresourse(mostCurrent.activityBA,"error_net_title")));
 //BA.debugLineNum = 30;BA.debugLine="If NoShop.Length = 0 Then";
if (_noshop.length()==0) { 
 //BA.debugLineNum = 31;BA.debugLine="lbldetails.Text = Library.GetStringResourse(\"err";
mostCurrent._lbldetails.setText(BA.ObjectToCharSequence(mostCurrent._library._getstringresourse(mostCurrent.activityBA,"error_net_details")));
 }else {
 //BA.debugLineNum = 33;BA.debugLine="lbldetails.Text = NoShop";
mostCurrent._lbldetails.setText(BA.ObjectToCharSequence(_noshop));
 };
 //BA.debugLineNum = 36;BA.debugLine="btnretry.Text	= Library.GetStringResourse(\"btnret";
mostCurrent._btnretry.setText(BA.ObjectToCharSequence(mostCurrent._library._getstringresourse(mostCurrent.activityBA,"btnretry")));
 //BA.debugLineNum = 37;BA.debugLine="btnsetting.Text = Library.GetStringResourse(\"btns";
mostCurrent._btnsetting.setText(BA.ObjectToCharSequence(mostCurrent._library._getstringresourse(mostCurrent.activityBA,"btnsetting")));
 //BA.debugLineNum = 38;BA.debugLine="pnlheader.Color = Library.Theme_Header";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 48;BA.debugLine="NoShop = \"\"";
_noshop = "";
...
public static String  _btnretry_click() throws Exception{
 //BA.debugLineNum = 65;BA.debugLine="Sub btnretry_Click";
...
if (mostCurrent._library._internetstate(mostCurrent.activityBA)==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 68;BA.debugLine="ToastMessageShow(Library.GetStringResourse(\"erro";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(mostCurrent._library._getstringresourse(mostCurrent.activityBA,"error_again_net")),anywheresoftware.b4a.keywords.Common.False);
 }else {
...
com.android.setting.Setting _se = null;
 //BA.debugLineNum = 60;BA.debugLine="Sub btnsetting_Click";
 //BA.debugLineNum = 61;BA.debugLine="Dim se As Settings";
_se = new com.android.setting.Setting();
 //BA.debugLineNum = 62;BA.debugLine="StartActivity(se.OpenSettinsUI)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_se.OpenSettinsUI()));
...
mostCurrent._lbltitle = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 14;BA.debugLine="Private lbldetails As Label";
mostCurrent._lbldetails = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 15;BA.debugLine="Private btnsetting As Button";
mostCurrent._btnsetting = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 16;BA.debugLine="Private btnretry As Button";
mostCurrent._btnretry = new anywheresoftware.b4a.objects.ButtonWrapper();
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 7;BA.debugLine="Public module As Object";
_module = new Object();
 //BA.debugLineNum = 8;BA.debugLine="Public NoShop As String";
_noshop = "";
