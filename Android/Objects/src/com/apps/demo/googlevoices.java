...
public class googlevoices extends Activity implements B4AActivity{
	public static googlevoices mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.apps.demo", "com.apps.demo.googlevoices");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (googlevoices).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.apps.demo", "com.apps.demo.googlevoices");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.apps.demo.googlevoices", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (googlevoices) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (googlevoices) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (googlevoices) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public anywheresoftware.b4a.phone.Phone.VoiceRecognition _voice = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 16;BA.debugLine="Activity.Color = Colors.Transparent";
mostCurrent._activity.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 18;BA.debugLine="voice.Initialize(\"VR\")";
mostCurrent._voice.Initialize("VR");
 //BA.debugLineNum = 20;BA.debugLine="If Library.manager.GetString(\"lang\") = \"English\"";
if ((mostCurrent._library._manager.GetString("lang")).equals("English")) { 
 //BA.debugLineNum = 21;BA.debugLine="voice.Language = \"en\"";
mostCurrent._voice.setLanguage("en");
 }else {
 //BA.debugLineNum = 23;BA.debugLine="voice.Language = \"fa\"";
mostCurrent._voice.setLanguage("fa");
 };
 //BA.debugLineNum = 26;BA.debugLine="voice.Prompt = Library.GetStringResourse(\"google_";
mostCurrent._voice.setPrompt(mostCurrent._library._getstringresourse(mostCurrent.activityBA,"google_voice"));
 //BA.debugLineNum = 28;BA.debugLine="End Sub";
return "";
}
public static String  _activity_pause(boolean _userclosed) throws Exception{
 //BA.debugLineNum = 46;BA.debugLine="Sub Activity_Pause (UserClosed As Boolean)";
 //BA.debugLineNum = 47;BA.debugLine="If UserClosed = True Then";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 11;BA.debugLine="Private voice As VoiceRecognition";
mostCurrent._voice = new anywheresoftware.b4a.phone.Phone.VoiceRecognition();
 //BA.debugLineNum = 12;BA.debugLine="End Sub";
return "";
}
public static String  _listen() throws Exception{
 //BA.debugLineNum = 30;BA.debugLine="Sub Listen";
 //BA.debugLineNum = 31;BA.debugLine="voice.Listen";
mostCurrent._voice.Listen(processBA);
...
public static String  _vr_result(boolean _success,anywheresoftware.b4a.objects.collections.List _texts) throws Exception{
 //BA.debugLineNum = 34;BA.debugLine="Sub VR_Result (Success As Boolean, Texts As List)";
 //BA.debugLineNum = 36;BA.debugLine="If Texts.IsInitialized = False Then Activity.Fini";
if (_texts.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
mostCurrent._activity.Finish();};
 //BA.debugLineNum = 37;BA.debugLine="Library.DoCommand(Texts)";
mostCurrent._library._docommand(mostCurrent.activityBA,_texts);
