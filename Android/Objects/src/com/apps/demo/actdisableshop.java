...
public class actdisableshop extends Activity implements B4AActivity{
	public static actdisableshop mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.apps.demo", "com.apps.demo.actdisableshop");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (actdisableshop).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.apps.demo", "com.apps.demo.actdisableshop");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.apps.demo.actdisableshop", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (actdisableshop) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (actdisableshop) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (actdisableshop) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 20;BA.debugLine="Activity.LoadLayout(\"frmdisactiveshop\")";
mostCurrent._activity.LoadLayout("frmdisactiveshop",mostCurrent.activityBA);
 //BA.debugLineNum = 21;BA.debugLine="pnlheader.Color = Library.Theme_Header";
...
mostCurrent._library._setlocalapp(mostCurrent.activityBA,mostCurrent._library._currlang);
 //BA.debugLineNum = 25;BA.debugLine="lblheader.Text	= Library.GetStringResourse(\"alert";
mostCurrent._lblheader.setText(BA.ObjectToCharSequence(mostCurrent._library._getstringresourse(mostCurrent.activityBA,"alert")));
 //BA.debugLineNum = 26;BA.debugLine="lbldesc.Text	= Library.GetStringResourse(\"shop_di";
mostCurrent._lbldesc.setText(BA.ObjectToCharSequence(mostCurrent._library._getstringresourse(mostCurrent.activityBA,"shop_disactive")));
 //BA.debugLineNum = 27;BA.debugLine="Library.LabelSpace(lbldesc,2)";
mostCurrent._library._labelspace(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._lbldesc.getObject())),(float) (2));
 //BA.debugLineNum = 28;BA.debugLine="btnok.Background = Library.GetButtonState";
mostCurrent._btnok.setBackground((android.graphics.drawable.Drawable)(mostCurrent._library._getbuttonstate(mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 29;BA.debugLine="btnok.Text		= Library.GetStringResourse(\"ok\")";
mostCurrent._btnok.setText(BA.ObjectToCharSequence(mostCurrent._library._getstringresourse(mostCurrent.activityBA,"ok")));
 //BA.debugLineNum = 31;BA.debugLine="Library.ChangeStatusColor";
...
public static String  _btnok_click() throws Exception{
 //BA.debugLineNum = 43;BA.debugLine="Sub btnok_Click";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 11;BA.debugLine="Private lbldesc As Label";
mostCurrent._lbldesc = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 12;BA.debugLine="Private lblheader As Label";
mostCurrent._lblheader = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 13;BA.debugLine="Private btnok As Button";
mostCurrent._btnok = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 14;BA.debugLine="Private pnlmain As Panel";
