...
public class actweb extends Activity implements B4AActivity{
	public static actweb mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.apps.demo", "com.apps.demo.actweb");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (actweb).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.apps.demo", "com.apps.demo.actweb");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.apps.demo.actweb", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (actweb) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (actweb) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (actweb) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
String _style = "";
 ...
 //BA.debugLineNum = 20;BA.debugLine="Activity.LoadLayout(\"frmweb\")";
mostCurrent._activity.LoadLayout("frmweb",mostCurrent.activityBA);
 //BA.debugLineNum = 21;BA.debugLine="lbltitle.Text = title";
mostCurrent._lbltitle.setText(BA.ObjectToCharSequence(_title));
 //BA.debugLineNum = 22;BA.debugLine="pnlheader.Color = Library.Theme_Header";
mostCurrent._pnlheader.setColor(mostCurrent._library._theme_header);
 //BA.debugLineNum = 23;BA.debugLine="lblpb.Text = Library.GetStringResourse(\"loading\")";
...
mostCurrent._library._changestatuscolor(mostCurrent.activityBA);
 //BA.debugLineNum = 27;BA.debugLine="Dim style As String";
_style = "";
 //BA.debugLineNum = 29;BA.debugLine="If Library.IsPersian Then";
if (mostCurrent._library._ispersian(mostCurrent.activityBA)) { 
 //BA.debugLineNum = 30;BA.debugLine="style = \"<body style=\"\"direction:rtl;text-align:";
_style = "<body style=\"direction:rtl;text-align:right !important;line-height:35px\"><p>";
 }else {
 //BA.debugLineNum = 32;BA.debugLine="style = \"<body style=\"\"direction:ltr;text-align:";
_style = "<body style=\"direction:ltr;text-align:left !important\"><p>";
 };
 //BA.debugLineNum = 35;BA.debugLine="If data.Length > 0 Then";
if (_data.length()>0) { 
 //BA.debugLineNum = 36;BA.debugLine="data = data.Replace(\"&gt;\",\">\").Replace(\"&lt;\",\"";
_data = _data.replace("&gt;",">").replace("&lt;","<").replace("&quot;",anywheresoftware.b4a.keywords.Common.QUOTE).replace("&amp;","&");
 //BA.debugLineNum = 37;BA.debugLine="data = style & data & \"</p>\"";
_data = _style+_data+"</p>";
 //BA.debugLineNum = 38;BA.debugLine="File.WriteString(File.DirRootExternal,\"a.html\",d";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"a.html",_data);
 //BA.debugLineNum = 39;BA.debugLine="wb1.LoadHtml(data)";
mostCurrent._wb1.LoadHtml(_data);
 //BA.debugLineNum = 40;BA.debugLine="data = \"\"";
_data = "";
 }else {
 //BA.debugLineNum = 42;BA.debugLine="pnlloading.SetVisibleAnimated(600,True)";
mostCurrent._pnlloading.SetVisibleAnimated((int) (600),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 43;BA.debugLine="wb1.LoadUrl(link)";
mostCurrent._wb1.LoadUrl(_link);
 //BA.debugLineNum = 44;BA.debugLine="link = \"\"";
_link = "";
 };
...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 ...
 //BA.debugLineNum = 67;BA.debugLine="If KeyCodes.KEYCODE_BACK = KeyCode Then";
if (anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK==_keycode) { 
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 11;BA.debugLine="Private wb1 As WebView";
...
public static String  _wb1_pagefinished(String _url) throws Exception{
 //BA.debugLineNum = 49;BA.debugLine="Sub wb1_PageFinished (Url As String)";
 //BA.debugLineNum = 50;BA.debugLine="pnlloading.SetVisibleAnimated(600,False)";
