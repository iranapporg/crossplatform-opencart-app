...
public class actshow extends Activity implements B4AActivity{
	public static actshow mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.apps.demo", "com.apps.demo.actshow");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (actshow).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.apps.demo", "com.apps.demo.actshow");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.apps.demo.actshow", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (actshow) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (actshow) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (actshow) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 18;BA.debugLine="Activity.LoadLayout(\"frmwaiting\")";
mostCurrent._activity.LoadLayout("frmwaiting",mostCurrent.activityBA);
 //BA.debugLineNum = 19;BA.debugLine="lblpb.Text = Library.GetStringResourse(\"loading\")";
mostCurrent._lblpb.setText(BA.ObjectToCharSequence(mostCurrent._library._getstringresourse(mostCurrent.activityBA,"loading")));
 //BA.debugLineNum = 21;BA.debugLine="Library.ChangeStatusColor";
...
com.apps.demo.opencart _op = null;
 ...
 //BA.debugLineNum = 27;BA.debugLine="If res.Length = 0 Then";
if (mostCurrent._res.length()==0) { 
 //BA.debugLineNum = 28;BA.debugLine="res = Library.ParseURL_Scheme(Activity.GetStarti";
mostCurrent._res = mostCurrent._library._parseurl_scheme(mostCurrent.activityBA,mostCurrent._activity.GetStartingIntent());
 };
 //BA.debugLineNum = 31;BA.debugLine="If res <> \"\" Then";
if ((mostCurrent._res).equals("") == false) { 
 //BA.debugLineNum = 33;BA.debugLine="Dim arr() As String";
_arr = new String[(int) (0)];
java.util.Arrays.fill(_arr,"");
 //BA.debugLineNum = 34;BA.debugLine="arr = Regex.Split(\"/\",res)";
_arr = anywheresoftware.b4a.keywords.Common.Regex.Split("/",mostCurrent._res);
 //BA.debugLineNum = 36;BA.debugLine="If IsNumber(arr(0)) Then";
if (anywheresoftware.b4a.keywords.Common.IsNumber(_arr[(int) (0)])) { 
 //BA.debugLineNum = 38;BA.debugLine="If Library.InternetState = False Then";
if (mostCurrent._library._internetstate(mostCurrent.activityBA)==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 39;BA.debugLine="StartActivity(actErrorIntrenet)";
...
if (true) return "";
 ...
 //BA.debugLineNum = 43;BA.debugLine="Dim op As OpenCart";
_op = new com.apps.demo.opencart();
 //BA.debugLineNum = 44;BA.debugLine="op.Initialize";
_op._initialize(processBA);
 //BA.debugLineNum = 45;BA.debugLine="op.ProductDetails(Me,\"Details_receive\",arr(0))";
_op._productdetails(actshow.getObject(),"Details_receive",_arr[(int) (0)]);
 }else {
...
public static String  _details_receive(anywheresoftware.b4a.objects.collections.Map _res1,String _cat) throws Exception{
 //BA.debugLineNum = 60;BA.debugLine="Sub Details_receive(res1 As Map,cat As String)";
 //BA.debugLineNum = 62;BA.debugLine="If res1.IsInitialized Then";
if (_res1.IsInitialized()) { 
 //BA.debugLineNum = 63;BA.debugLine="actProduct.product = res1";
mostCurrent._actproduct._product = _res1;
 //BA.debugLineNum = 64;BA.debugLine="StartActivity(actProduct)";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 11;BA.debugLine="Private pnlloading As Panel";
mostCurrent._pnlloading = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 12;BA.debugLine="Private lblpb As Label";
