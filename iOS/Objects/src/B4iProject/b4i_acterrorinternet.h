...
@class _period;
@class b4i_imagezoom;
@interface b4i_acterrorinternet : B4IStaticModule
- (NSString*)  _btnretry_click;
- (NSString*)  _btnsetting_click;
- (NSString*)  _process_globals;
@property (nonatomic)NSObject* _module;
@property (nonatomic)NSString* _noshop;
@property (nonatomic)B4ILabelWrapper* _lbltitle;
@property (nonatomic)B4ILabelWrapper* _lbldetails;
@property (nonatomic)B4IButtonWrapper* _btnsetting;
@property (nonatomic)B4IButtonWrapper* _btnretry;
@property (nonatomic)B4IPanelWrapper* _pnlheader;
@property (nonatomic)B4ILabelWrapper* _lblalert;
