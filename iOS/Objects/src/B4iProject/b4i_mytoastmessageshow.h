...
@class _period;
@class b4i_imagezoom;
@interface b4i_mytoastmessageshow : B4IClass
- (NSString*)  _class_globals;
@property (nonatomic)B4IPanelWrapper* _p1;
@property (nonatomic)B4ITimer* _timerdelay;
@property (nonatomic)B4ILabelWrapper* _lbl;
@property (nonatomic)B4ILabelWrapper* _bullet;
