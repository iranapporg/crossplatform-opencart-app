...
@class _period;
@class b4i_imagezoom;
@interface b4i_actcategory : B4IStaticModule
...
@property (nonatomic)b4i_opencart* _category;
@property (nonatomic)B4ILabelWrapper* _lblctitle;
@property (nonatomic)B4IImageViewWrapper* _imgicon;
@property (nonatomic)B4IPanelWrapper* _pncategory;
@property (nonatomic)B4IPanelWrapper* _pnlheader;
@property (nonatomic)B4IList* _historycategory;
@property (nonatomic)B4IPanelWrapper* _pnloverreturn;
@property (nonatomic)B4ILabelWrapper* _lblrtitle;
@property (nonatomic)B4IPanelWrapper* _pnlreturn;
@property (nonatomic)int _top;
@property (nonatomic)B4IImageViewWrapper* _imgiconcat;
@property (nonatomic)B4IPanelWrapper* _pnlovercat;
@property (nonatomic)B4ILabelWrapper* _lblbasket;
@property (nonatomic)NSString* _currentcategoryid;
