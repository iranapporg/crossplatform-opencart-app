...
@class _period;
@class b4i_imagezoom;
@interface b4i_actregister : B4IStaticModule
...
@property (nonatomic)BOOL _guest;
@property (nonatomic)B4IScrollView* _sv1;
@property (nonatomic)B4IButtonWrapper* _btnregister;
...
@property (nonatomic)NSObject* _top;
@property (nonatomic)b4i_opencart* _op1;
@property (nonatomic)B4IPanelWrapper* _pnlheader;
@property (nonatomic)B4IList* _listcountry;
@property (nonatomic)B4IList* _listcity;
@property (nonatomic)b4i_opencart* _opcountry;
@property (nonatomic)b4i_opencart* _opcity;
@property (nonatomic)B4IPickerWrapper* _spcity;
@property (nonatomic)BOOL _successregister;
@property (nonatomic)b4i_mytoastmessageshow* _mytoastmessageshow1;
@property (nonatomic)B4ISwitchWrapper* _chknewsletter;
