...
@class _period;
@interface b4i_imagezoom : B4IClass
...
@property (nonatomic)float _mnscale;
@property (nonatomic)float _mxscale;
@property (nonatomic)float _zscale;
@property (nonatomic)B4INativeObject* _nosc;
@property (nonatomic)NSString* _munzoomdt;
