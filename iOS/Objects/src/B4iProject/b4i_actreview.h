...
@class _period;
@class b4i_imagezoom;
@interface b4i_actreview : B4IStaticModule
...
@property (nonatomic)NSString* _rate;
...
@property (nonatomic)B4ILabelWrapper* _lblrate;
@property (nonatomic)B4ILabelWrapper* _lbltext;
@property (nonatomic)B4ITextViewWrapper* _txttext;
@property (nonatomic)B4IButtonWrapper* _btnsend;
