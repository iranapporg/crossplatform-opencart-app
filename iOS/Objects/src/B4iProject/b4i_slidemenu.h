...
@class _period;
@class b4i_imagezoom;
@interface b4i_slidemenu : B4IClass
...
@property (nonatomic)BOOL _addinformation;
@property (nonatomic)b4i_customlistview* _lsheader;
@property (nonatomic)NSObject* _memodule;
@property (nonatomic)NSString* _subscribestate;
@property (nonatomic)B4ITimer* _tmrdelay;
@property (nonatomic)NSString* _value;
@property (nonatomic)B4IPage* _pageside;
@property (nonatomic)B4ISideMenuController* _side;
@property (nonatomic)B4IPanelWrapper* _pnlslide;
@property (nonatomic)B4IImageViewWrapper* _imglogo;
@property (nonatomic)B4ILabelWrapper* _lbltitle;
@property (nonatomic)int _left;
@property (nonatomic)int _width;
@property (nonatomic)B4ILabelWrapper* _lblicon;
@property (nonatomic)B4ILabelWrapper* _lbltitle_header;
@property (nonatomic)B4IViewWrapper* _v2;
