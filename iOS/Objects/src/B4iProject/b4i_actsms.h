...
@class _period;
@class b4i_imagezoom;
@interface b4i_actsms : B4IStaticModule
...
@property (nonatomic)B4ITextViewWrapper* _txtcomment;
@property (nonatomic)B4ILabelWrapper* _lblcomment;
@property (nonatomic)B4IButtonWrapper* _btnproduts;
@property (nonatomic)B4IButtonWrapper* _btnclose;
@property (nonatomic)B4IMessageComposer* _ps;
